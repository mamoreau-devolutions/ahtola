...
namespace Ahtola.EntityFrameworkCore.Sqlite.Update.Internal;

public sealed class AhtolaSqliteUpdateSqlGenerator(UpdateSqlGeneratorDependencies dependencies) : UpdateAndSelectSqlGenerator(dependencies)
{
